...
<div class="inner-sct">
	...
	<div class="lead-txt">
		<p>バーベナは就労継続支援Ｂ型の<span>福祉サービス事業所</span>です</p>
	</div>
	<div class="ctn-flex">
		<div class="txt">
	...
	<div class="btn-area">
		...
		<a href="<?php echo esc_url( home_url( '/staff/' ) ); ?>" class="btn btn-secondary">スタッフ紹介を見る</a>
	</div>
</div>
</section>
...
<div class="inner-sct">
	...
	<p class="works-lead">障がいや体調に合わせ、ご自分のペースで働けます。</p>
<?php if ( have_posts() ) : ?>
<?php while ( have_posts() ) : the_post(); ?>
	<?php the_content(); ?>
<?php endwhile; ?>
<?php endif; ?>
	<p class="works-features"><strong>お昼ごはん無料</strong> ／ <strong>工賃あり</strong> ／ <strong>週1日からOK</strong></p>
	<div class="btn-area">
		<a href="<?php echo esc_url( home_url( '/work/' ) ); ?>" class="btn">お仕事内容を詳しく見る</a>
	</div>
	<p class="business-link"><a href="<?php echo esc_url( home_url( '/business/' ) ); ?>">企業様からのご依頼もお待ちしています →</a></p>
</div>
</section>
...
<section id="news">
<div class="inner-sct">
	<div class="ctn-flex news-flex">
		<div class="tit">
			<h2><img src="<?php echo esc_url( home_url( '/img/' ) ); ?>ttl-news.png"><span>お知らせ</span></h2>
			<div class="more">
				<a href="<?php echo esc_url( home_url( '/news/' ) ); ?>" class="btn btn-small">一覧を見る</a>
			</div>
		</div>
		<div class="ctn">
			<ul>
...
<div class="inner-sct">
	...
	<div class="contact-cta">
		...
		<div class="contact-box">
			...
			<p class="contact-tel"><a href="tel:044-982-9006">044-982-9006</a></p>
			<p class="contact-note">受付時間：平日 9:00〜15:00</p>
		</div>
		<!-- フォームへのリンク -->
		<div class="contact-box">
			<p class="contact-label">フォームでのお問い合わせ</p>
			<a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>" class="btn btn-large">お問い合わせフォームへ</a>
		</div>
	</div>
</div>
</section>
